...
spc, wr, res_s = Spectral(fname, win_length=window), WindowReject(fname, window), Result(fname, window)
...
res_s.plot_spectral(vh_res, vh_reject, vh_avg, vh_med_curve, vh_std, vh_std_curve,
...
# Instantiating object
plr, res_p = Polarization(fname, win_length=window), Result(fname, window)
...
# Plotting and saving the result
res_p.plot_polar(azimuth, incidence, rectilinearity, planarity, max_eig, xtime, batch_proc=False)
