"""Class definition for SpectralRatio, a V/H (or H/V) spectral ratio processing module."""
...
class Spectral():
    """Class for instantiating 3-component sensor and performing spectral ratio.
